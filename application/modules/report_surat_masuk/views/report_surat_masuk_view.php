         ...
         <div class="row clearfix">
             <div class="col-lg-12">
                 <div class="card">
                     ...
                     <div class="body"> 
                     <form method="post" id="report_surat_masuk_form" enctype="multipart/form-data" action="<?php echo base_url('report_surat_masuk/process_report')?>" target="_blank">
                       <h2 align="center"> Cetak Laporan Surat Masuk </h2>
...
<script type="text/javascript">  
     ...
     function Simpan_Data() {
        window.open("<?php echo base_url('report_surat_masuk/save_report/')?>", "_blank"); 
         //setting semua data dalam form dijadikan 1 variabel 
         var formData = new FormData($('#report_surat_masuk_form')[0]);  
         ...
         if(tanggal_masuk == ''){
            ...
            $.ajax({
                 url: "<?php echo base_url(); ?>report_surat_masuk/simpan_data_report_surat_masuk",
                 type: "POST",
                 data: formData,
                 contentType: false,
                 processData: false,
                 success: function(result) {
                     ...
                     $('#report_surat_masuk_form')[0].reset();
                     $('.myprogress').text('0%');
